...
@synthesize quadLibrary,materialLibrary;
...
- (BBTexturedQuad*)texturedQuadFromImage:(NSString*)imageName {
	[self loadTextureImage:[imageName stringByAppendingPathExtension:@"png"] materialKey:imageName];
	BBTexturedQuad * quad = [[BBTexturedQuad alloc] init];
	
	
	quad.uvCoordinates[0] = 0;
	quad.uvCoordinates[1] = 1;
	
	quad.uvCoordinates[2] = 1;
	quad.uvCoordinates[3] = 1;
	
	quad.uvCoordinates[4] = 0;
	quad.uvCoordinates[5] = 0;
	
	quad.uvCoordinates[6] = 1;
	quad.uvCoordinates[7] = 0;
	
	quad.materialKey = imageName;
